...
<head>
    ...
    <title>Lexnay - Diligencias</title>
...
<body>
    <div class="main-wrapper">
        ...
        <div class="lx-ad-container" style="background-image: url(<?php echo $imageFolder ?>diligencias.jpg); background-size: cover;">
            <h1>Necesito Ayuda con una Diligencia</h1>
            <div class="option-1">
                <h2>¡Facilitamos tus trámites o procesos en Nayarit!</h2>
        ...
        <div class="band-c" id="band-1">
            ...
            <div class="answer">
                <h2>Si vives fuera de Nayarit, pero necesitas ayuda realizando algún tipo de trámite o estando al pendiente de algún proceso, puedes contratar nuestros servicios para ayudarte.</h2>
            </div>
        </div>
        ...
        <div class="start-wrapper">
            <div class="start-process-container">
                ...
                <h1 class="start-h1 start-title">Necesito ayuda una Diligencia</h1>
