...
<body>
    <div class="main-wrapper">
        ...
        <div class="lx-ad-container" style="background-image: url(<?php echo $imageFolder ?>ley.jpg); background-size: cover;">
            <h1>Necesito ayuda un proceso legal</h1>
            <div class="option-1">
                <h2>¡Te ayudamos en tu proceso o juicio legal!</h2>
        ...
        <div class="band-c" id="band-1">
            ...
            <div class="answer">
                <h2>Hay un sinfín de problemas legales que se pueden generar, si necesitas ayuda, contáctanos.</h2>
            </div>
        </div>
        ...
        <div class="start-wrapper">
            <div class="start-process-container">
                ...
                <h1 class="start-h1 start-title">Necesito ayuda Legal</h1>
